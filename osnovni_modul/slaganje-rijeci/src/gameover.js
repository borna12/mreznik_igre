...
Lettris.GameOver.prototype = {
	...
	this.game.add.text(this.game.world.centerX,
			   600,
			   "(Najbolji rezultati su vidljivi u )",
			   style).anchor.setTo(0.5)


	this.backButton = new TextButton(this.game, "Glavni izbornik",
	...
	var header = this.game.add.text(this.game.world.centerX,
					340,
					"Riječ koja nosi najviše bodova",
					style)
	...
	this.submit = new TextButton(this.game, "Predaj",
				    this.game.world.centerX, 760,
	...
	this.backButton = new TextButton(this.game, "Izbornik",
					 this.game.world.centerX, 760,
					 this.leave, this)
    },
    leave: function() {
