...
Lettris.MainMenu.prototype = {
	...
	// Tip of the day
	var tips = ["Misao dana broj 1", "Misao dana broj 2", "Misao dana broj 3"]
	...
	// Buttons
	this.boxes = 0
	this.addMenuButton("IGRAJ", 'Tutorial')
	this.addMenuButton("ZASLUGE", 'Credits')

	var allWords = JSON.parse(localStorage.getItem('Stats-' + this.game.language))
	if( allWords && allWords.length > 100)
	    this.addMenuButton("STATISTIKA", 'Stats')
