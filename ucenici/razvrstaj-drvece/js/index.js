...
$('.fb').click(function () {
  t = time;
  window.open('https://www.facebook.com/sharer/sharer.php?u='+adresa+'&picture='+adresa.replace('index.html', 'og_slika.jpg')+'&description=Igra u kojoj trebate razvrstati drveće na crnogorično i bjelogorično. O svakome ćete stablu dobiti informacije nakon što ga pravilno razvrstate.', 'targetWindow', 'toolbar=no,location=0,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=250');
})
