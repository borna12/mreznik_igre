    ...
    function odgovor() {
        ...
        if (document.getElementById("pageBeginCountdown").value == "0" && iskljuci_v == 0) {
            ...
            swal({
                ...
                html: "<p class='dodatak'>Točan odgovor je: <span class='nastavak'>" + prezent[questionCounter].split(" = ")[1] + "</span> = " + prezent[questionCounter].split(" = ")[0] + "<br></p><br><img src='slike/vrijeme.png'class='slikica2'/>",
            ...
            if ($("#odgovor").val().toLowerCase() == prezent[questionCounter].split(" = ")[1].toLowerCase()) {
                ...
                swal({
                    title: "Netočno",
                    html: "<p class='dodatak'>Točan odgovor je: <span class='nastavak'>" + prezent[questionCounter].split(" = ")[1] + "</span> = " + prezent[questionCounter].split(" = ")[0] + "<br></p><br><img src='slike/krivo.png' class='slikica2'/>",
                    showCloseButton: true,
                    confirmButtonText: ' dalje',
                    backdrop: false,
                    allowOutsideClick: false,
