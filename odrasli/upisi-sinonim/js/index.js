...
$(document).ready(function() {
    ...
    generateQuestionAndAnswers = function() {
        broj = Math.floor(Math.random() * 2) + 1
        ...
        if (broj == 1) {
            $("#osnova2").text(prezent[questionCounter].sinonim1)
            $("#oblik").html("<br> prvo slovo odgovora je: " + prezent[questionCounter].sinonim2[0].toLowerCase() + "<br>broj slova:" + prezent[questionCounter].sinonim2.length)
        } else {
            $("#osnova2").text(prezent[questionCounter].sinonim2)
            $("#oblik").html("<br> prvo slovo odgovora je: " + prezent[questionCounter].sinonim1[0].toLowerCase() + "<br>broj slova:" + prezent[questionCounter].sinonim1.length)
        }
    ...
    getCorrectAnswer = function() {
        if (broj == 1) {
            correctAnswer = prezent[questionCounter].sinonim2;
        } else { correctAnswer = prezent[questionCounter].sinonim1; }
    };
    ...
    function odgovor() {
        ...
        if (document.getElementById("pageBeginCountdown").value == "0" && iskljuci_v == 0) {
            if (broj == 1) { pogreske.push("<strong>" + prezent[questionCounter].sinonim2 + "</strong> = " + prezent[questionCounter].sinonim1) }
            bodovi -= 10;
            $("#zvono")[0].play();
            swal({
            ...
            if (broj == 1 && $("#odgovor").val().toLowerCase() == prezent[questionCounter].sinonim2) {
            ...
            } else if (broj == 2 && $("#odgovor").val().toLowerCase() == prezent[questionCounter].sinonim1) {
                correctAnswersCounter++;
                bodovi += 10;
                if (iskljuci_v == 1) {
                    vrijeme = 0
                ...
                pogreske.push("<strong>" + prezent[questionCounter].sinonim2 + "</strong> = " + prezent[questionCounter].sinonim1)
                bodovi -= 10;
                $("#odgovor").val('')
    ...
    function nastavi() {
        ...
        if (questionCounter < prezent.length - 1) {
            ...
            //obrazac za pohranu
            if (kategorija == "djeca") {
                if (sadrzaj1 == "p1") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLScU9cmcOTYJPvbSuogJlEb5pUZjWi8FECpth09BUau_krvFKQ/formResponse") } else if (sadrzaj1 == "p2") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSeKAHLyXWZMuaiEA__KtfQ1Et4N4sbM4RaiWO8KKsyMylKiDg/formResponse") } else if (sadrzaj1 == "p3") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSckDVcMBmFxnqyr0Bu_Hvn1mjdudlODjHvB4mF1pDIZN_lr6Q/formResponse") } else if (sadrzaj1 == "p3.concat(p1).concat(p2)") {
                ...
                if (sadrzaj1 == "p1") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLScrSDrvsrsFuEjKQERdMRowgudmAm_5SWeZJRBlIbk39KBD0g/formResponse") } else if (sadrzaj1 == "p2") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSfXXwiReJjr-IZ74no-ag5Oao6doCPDkJPCjYp5nHN5QK5aVw/formResponse") } else if (sadrzaj1 == "p3") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSeoDIe2NnvTjt3n_RjXP9_Cc84uTgebUySQ6_4ROFIW3LC_0g/formResponse") } else if (sadrzaj1 == "p3.concat(p1).concat(p2)") {
                ...
                if (sadrzaj1 == "p1") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSdyDp3bGU_e-vvkdYNE-cn7WMmd0nOnGqIXTnW0q3N6hUy1-w/formResponse") } else if (sadrzaj1 == "p2") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSeJVyCRIM5NEDn5Wy8z22HJx_VFs5tNausfikHIqRjsdJ7foQ/formResponse") } else if (sadrzaj1 == "p3") { $("#bootstrapForm").attr("action", "https://docs.google.com/forms/d/e/1FAIpQLSc9-P2JrOcid-DmclLnBDukCPzyd7lrDF7b1NRViCZhxQk1IQ/formResponse") } else if (sadrzaj1 == "p3.concat(p1).concat(p2)") {
